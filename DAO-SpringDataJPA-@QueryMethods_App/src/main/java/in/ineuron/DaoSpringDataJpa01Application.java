...
public class DaoSpringDataJpa01Application {
	...
	public static void main(String[] args) {
		...
		/*
		 * service.fetchVaccinesByCompanies("bharathbiotech",
		 * "serum").forEach(System.out::println); System.out.println();
		 * 
		 * List<Object[]> names = service.fetchVaccinesByName("covidshield", "covacin");
		 * for (Object[] objects : names) { for (Object obj : objects) {
		 ...
		 * 
		 * System.out.println("No of records updated is :: " +
		 * service.modifyingPriceByCountry(800.0, "USA"));
		 * System.out.println("No of records deleted is :: " +
		 * service.removeVacinesByPrice(750.0, 1000.0));
		 * 
