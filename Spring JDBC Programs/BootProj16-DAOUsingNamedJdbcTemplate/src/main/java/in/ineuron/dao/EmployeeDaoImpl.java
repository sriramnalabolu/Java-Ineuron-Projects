...
public class EmployeeDaoImpl implements IEmployeeDao {
	...
	private static final String GET_EMPLOYEE_BY_DESG = 
			"SELECT EID,ENAME,EAGE,EADDRESS,DESG,SALARY FROM EMPLOYEE WHERE DESG IN(:desg1,:desg2,:desg3)";

	private static final String INSERT_EMPLOYEE = 
			"INSERT INTO EMPLOYEE(`ename`,`eage`,`eaddress`,`desg`,`salary`)values(:ename,:eage,:eaddress,:desg,:salary)";
